...
$$key = $value;  
2.函数覆盖变量：parse\_str、mb\_parse\_str、import\_request\_variables  
...
08 $\_SESSION\[‘do’\]=1;  
09 echo(session\_id());  
10 print\_r($\_SESSION);  
11 }  
12 ?>  
当我们提交cookie![](https://mmbiz.qpic.cn/mmbiz_gif/mpEnHdrckpQhiaAGIwicZYE55Gd5674Rmr4jzu1BAXo4v1bWr1zfEbfrJRrmHiaO8hmQzvccOJBB1nEEH2c7CDnSA/640?wx_fmt=gif)HPSESSIONID=/../1.php，相当于删除了此文件  
