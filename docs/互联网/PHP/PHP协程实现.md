...
协程可以理解为**纯用户态** 的线程，通过协作而不是抢占来进行任务切换。相对于进程或者线程，协程所有的操作都可以在用户态而非操作系统内核态完成，创建和切换的消耗非常低。
...
![14913877605869.jpg](http://pic.3513.top/github/page/c51bea1147d91c91f919e7d5a61e59fd.jpg)
